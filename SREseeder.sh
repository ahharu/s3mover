...
# );
# --------------------------
DB_CONN_STRING = os.getenv('DB_CONN_STRING', 'mysql+pymysql://root:supersecure@127.0.0.1/proddatabase')
...
S3_BUCKET_NAME = os.getenv('S3_BUCKET_NAME', 'legacys3')

# S3 connection details
S3_ENDPOINT_URL = os.getenv('S3_ENDPOINT_URL', 'http://127.0.0.1:9000')
AWS_ACCESS_KEY_ID = os.getenv('AWS_ACCESS_KEY_ID', 'minioadmin')
AWS_SECRET_ACCESS_KEY = os.getenv('AWS_SECRET_ACCESS_KEY', 'minioadmin')
AWS_DEFAULT_REGION = os.getenv('AWS_DEFAULT_REGION', 'us-eat-1')
